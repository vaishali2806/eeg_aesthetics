...
%     dat.sub_age = input('Enter subject age : ');
    ...
    imageFiles = dir('D:\EEG_aesthetics_SN_VG\Thesis_VG\stimulus\art_all_renamed\*.jpg');
    imageData = struct();
    ...
    trial_timing = [];
    for trial=1: 300 %length(dat.new_stim)%cfg.trialamount
        ...
        img_rand = desaturate_image(img_rand_orig);
